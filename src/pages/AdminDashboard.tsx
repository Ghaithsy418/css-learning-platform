...
const lessonNames: Record<string, string> = {
  ...
  'adv-js-1': 'Advanced JS: محرك JavaScript',
  'adv-js-2': 'Advanced JS: بيئة المتصفح',
  'adv-js-3': 'Advanced JS: الدوال المغلقة',
  'adv-js-4': 'Advanced JS: أحداث DOM',
  'adv-js-5': 'Advanced JS: النماذج الوراثية',
  'adv-js-6': 'Advanced JS: فئات ES6',
  'adv-js-7': 'Advanced JS: حلقة الأحداث',
  'adv-js-8': 'Advanced JS: Promises و Fetch',
  'adv-js-9': 'Advanced JS: Async Await',
  'adv-js-10': 'Advanced JS: التخزين المحلي',
  'adv-js-11': 'Advanced JS: الوحدات',
  'adv-js-12': 'Advanced JS: المشروع النهائي',
};
...
const lessonCategories: {
  ...
  },
  {
    ...
    color: 'text-cyan-400',
    lessons: [
      { id: 'adv-js-1', label: 'محرك JavaScript' },
      { id: 'adv-js-2', label: 'بيئة المتصفح' },
      { id: 'adv-js-3', label: 'الدوال المغلقة' },
      { id: 'adv-js-4', label: 'أحداث DOM' },
      { id: 'adv-js-5', label: 'النماذج الوراثية' },
      { id: 'adv-js-6', label: 'فئات ES6' },
      { id: 'adv-js-7', label: 'حلقة الأحداث' },
      { id: 'adv-js-8', label: 'Promises و Fetch' },
      { id: 'adv-js-9', label: 'Async Await' },
      { id: 'adv-js-10', label: 'التخزين المحلي' },
      { id: 'adv-js-11', label: 'وحدات ES6' },
      { id: 'adv-js-12', label: 'المشروع النهائي' },
    ],
  },
];
